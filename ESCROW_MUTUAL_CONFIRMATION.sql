...
COMMENT ON COLUMN credit_escrow.release_available_at IS 'When 7-day minimum hold expires (funds can release if both confirmed)';
COMMENT ON COLUMN credit_escrow.dispute_reported_at IS 'When dispute was reported (admin has 48hr to respond)';
